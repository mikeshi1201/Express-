...
- (void)initializer
{
    ...
    for (NSUInteger i = 0; i < 2; ++i)
    {
        ...
        [self addConstraints:@[
                               ...
                               [NSLayoutConstraint constraintWithItem:buttonView attribute:alignmentAttribute relatedBy:NSLayoutRelationEqual toItem:clipView attribute:alignmentAttribute multiplier:1.0 constant:-20.0],
